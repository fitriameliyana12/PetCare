        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    ...
                    ?>
                    <h3 class="text-center">Data PetCare</h3>
                    <a href="<?php echo site_url(); ?>petcareClient/post" class="btn btn-info mb-3 bg-info" role="button">Tambah</a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <a href="<?php echo site_url(); ?>petcareClient/delete/<?php echo $rows->id; ?>" class="btn btn-info bg-info" role="button">Hapus</a>
